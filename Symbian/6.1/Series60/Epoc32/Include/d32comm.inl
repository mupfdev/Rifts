...
inline TInt RBusDevComm::Open(TInt aUnit)
	{return(DoCreate(KRBusDevComm,VersionRequired(),NULL,aUnit,NULL,NULL));}
...
inline TInt RBusDevComm::SetReceiveBufferLength(TInt aLength)
	{return(DoSvControl(EControlSetReceiveBufferLength,(TAny *)aLength));}
...
inline void RBusDevComm::NotifyReceiveDataAvailable(TRequestStatus& aStatus)
	{DoRequest((ERequestRead|KDataAvailableNotifyFlag),aStatus);}
...
inline TInt RBusDevCommDCE::Open(TInt aUnit)
	{return(DoCreate(KRBusDevCommDCE,VersionRequired(),NULL,aUnit,NULL,NULL));}
