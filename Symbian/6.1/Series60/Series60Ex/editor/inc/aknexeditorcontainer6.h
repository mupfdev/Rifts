...
#ifndef AKNEXEDITORCONTAINER6_H
#define AKNEXEDITORCONTAINER6_H
...
const TInt KNumberOfEdwins      = 2;
const TInt KNumberOfGTextEds    = 2;
const TInt KNumberOfLabels      = 4;
...
*  
*/
class CAknExEditorContainer6 : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        /**
        * C++ default constructor.
        */
        CAknExEditorContainer6();
        ...
        * Destructor.
        */
        virtual ~CAknExEditorContainer6();
