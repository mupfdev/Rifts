...
/*!
  ...
  @discussion Create a CMultiViewsView1 object
  @result a pointer to the created instance of CMultiViewsView1
*/
...
/*!
  ...
  @discussion  Perform the second phase construction of a CMultiViewsView1 object
*/
    void ConstructL();
