...
#ifndef AKNEXLISTFORMVIEW_H
#define AKNEXLISTFORMVIEW_H
...
class CAknExListFormContainer;

// CLASS DECLARATION

/**
* CAknExListFormView view class.
*/
class CAknExListFormView : public CAknExListBaseView
    {
    ...
    private: // Data
        ...
        CAknExListFormContainer* iContainer;
