...
# installed.
TK_PREFIX='/epoc32/gcc'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/epoc32/gcc'

# CYGNUS LOCAL
# -I switch(es) to pick up the tk.h header file from its build
# directory.
TK_BUILD_INCLUDES='-I/gdb_src/tk/generic -I/gdb_src/tk/xlib'
# END CYGNUS LOCAL
...
# build directory.
TK_BUILD_LIB_SPEC='-L/gdb_build/tk/win -ltk80'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/epoc32/gcc/lib -ltk80'
